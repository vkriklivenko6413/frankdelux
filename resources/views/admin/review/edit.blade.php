    ...
    <div class="card mb-3">
        ...
        <div class="card-body bg-light">
            <div class="tab-content">
                <form action="{{ route('admin.review.change', $review->id) }}" method="post" enctype="multipart/form-data">
                    @csrf
                    <div class="tab-pane preview-tab-pane active" role="tabpanel">
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                ...
                                <input class="form-control" id="title" value="{{ $review->name['ru'] }}"
                            ...
                            <div class="col-md-6">
                                ...
                                <input class="form-control" id="title_uk" value="{{ $review->name['ro']}}"
                            ...
                            <div class="col-md-6">
                                ...
                                <textarea class="form-control" id="message2"
                                          name="description_ru" type="text"> {{ $review->description['ru'] }}</textarea>
                            </div>
                            ...
                            <div class="col-md-6">
                                ...
                                <textarea class="form-control" id="message1"
                                          name="description_ro" type="text"> {{$review->description['ro'] }}</textarea>
                            </div>
