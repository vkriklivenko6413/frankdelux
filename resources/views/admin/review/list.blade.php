    ...
    <div class="card mb-3">
        <div class="card-body">
            <div class="row flex-between-center">
                ...
                <div class="col-auto">
                    <a href="{{ route('admin.review.add') }}" class="btn btn-success me-1 mb-1">
                        Создать
                    </a>
                </div>
            </div>
...
{{--                        </th>--}}
                    ...
                    @foreach($reviews as $review)
                        <tr>
                            ...
                            <td class="title">{{ $review->name['ru'] }}</td>

                            <td>

                                <a href="{{ route('admin.review.edit', $review->id) }}" class="btn p-0 info-btn"
                                ...
                                <a href="{{ route('admin.review.delete', $review->id) }}" class="btn p-0 delete-btn"
                                   type="submit">
