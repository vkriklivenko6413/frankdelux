                ...
                <div class="card-body bg-light">
                    <div class="tab-content">
                        <div class="tab-pane fade show active" id="nav-questionnaire" role="tabpanel">
                            <form action="{{ route('admin.block.update.blockFour', $blockFour->id) }}" method="POST"
                                ...
                                <div class="tab-pane preview-tab-pane active" role="tabpanel">
                                    <div class="row">
                                        <div class="col-md-6">
                                            ...
                                            <input class="form-control" id="title" value="{{ $blockFour->title['ru'] }}"
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <input class="form-control" id="title"
                                                   value="{{ $blockFour->description['ru'] }}"
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <input class="form-control" id="title_uk"
                                                   value="{{ $blockFour->description['ro'] }}"
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <textarea class="form-control" id="message2"
                                                      name="button_ru"
                                                      type="text"> {{ $blockFour->button['ru'] }}</textarea>
                                        </div>
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <textarea class="form-control" id="message1"
                                                      name="button_ro"
                                                      type="text"> {{ $blockFour->button['ro'] }}</textarea>
                                        </div>
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <img
                                                src="{{ asset('storage/block/') }}/{{$blockFour->photo}}"
                                                alt=""
                                                style="width: 150px"
                                            >
                                        </div>
